...
function Registration() {
  ...
  return (
    ...
    <div className='w-[100%] h-[100px] flex items-center justify-center flex-col gap-[10px]'>
        <span className='text-[25px] font-serif'>Sign Up</span>
    ...
    <div className='max-w-[600px] w-[90%] h-[500px] bg-[#e9d2ba] border-[1px] border-[black] backdrop:blur-2xl shadow-lg flex items-center justify-center '>
        <form action="" onSubmit={handleSignup} className='w-[90%] h-[90%] flex flex-col items-center justify-start gap-[20px]'>
            <div className='w-[90%] h-[50px] bg-[#fbecde] font-serif flex items-center justify-center gap-[10px] py-[20px] cursor-pointer' onClick={googleSignup} >
                <img src={google}  alt="" className='w-[20px]'/> Registration with Google
            </div>
            <div className='w-[100%] h-[20px] flex items-center justify-center gap-[10px]'>
             <div className='w-[40%] h-[1px] bg-[#fbecde]'></div> OR <div className='w-[40%] h-[1px] bg-[#fbecde]'></div>
            </div>
            <div className='w-[90%] h-[400px] flex flex-col items-center justify-center gap-[15px]  relative'>
                <input type="text" className='w-[100%] h-[50px] border-[2px] border-[black] backdrop:blur-sm shadow-lg bg-[#fbecde] placeholder-[black] px-[20px] font-serif' placeholder='UserName' required onChange={(e)=>setName(e.target.value)} value={name}/>
                 <input type="text" className='w-[100%] h-[50px] border-[2px] border-[black] backdrop:blur-sm shadow-lg bg-[#fbecde] placeholder-[black] px-[20px] font-serif' placeholder='Email' required onChange={(e)=>setEmail(e.target.value)} value={email}/>
                  ...
                  <button className='w-[100%] h-[50px] bg-[#fbecde] flex items-center justify-center mt-[20px] text-[17px] font-serif'>{loading? <Loading/> :"Create Account"}</button>
                  <p className='flex gap-[10px]'>You have any account? <span className='text-[black] text-[17px] font-serif cursor-pointer' onClick={()=>navigate("/login")}>Login</span></p>
            </div>
        </form>
    </div>
    </div>
